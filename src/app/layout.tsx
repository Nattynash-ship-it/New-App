...
const themeInit = `(function(){try{var v=["glass","bubblegum","daylight","nocturne","midnight"];var t=localStorage.getItem("hub-theme");if(t==="cartoon")t="bubblegum";if(t&&v.indexOf(t)>=0){document.documentElement.dataset.theme=t;localStorage.setItem("hub-theme",t)}else{document.documentElement.dataset.theme="glass";if(t)localStorage.setItem("hub-theme","glass")}}catch(e){}})()`;
